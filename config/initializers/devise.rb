...
Devise.setup do |config|
  ...
  # config.pepper = "f6f4033d912d8d1158e8d22c9c07edc2044ccd27ed5b1f2d928ff7b224275e96e8e684259913c0a8e80290f59402f476613b056d02b21646fc16b3b1c51e3313"
  ...
  config.timeout_in = Configuration.login_timeout.value.to_i.minutes
  ...
  config.warden do |manager|
    manager.strategies.add(:login_with_username_or_email) do
      ...
      def authenticate!
        ...
        resource = User.find(:first, :conditions => {:nome_usuario => login})
        if resource.nil?
